...
class ESwinTransformer(nn.Module):

    def __init__(self, img_size=32, patch_size=1, in_chans=3, num_classes=10,embed_dim=96, depths=[2, 2, 4, 2], kernel_size=7, num_heads=[6, 12, 24],
                 window_size=2, mlp_ratio=4., qkv_bias=True, qk_scale=None, drop_rate=0., attn_drop_rate=0., drop_path_rate=0.1, norm_layer=nn.LayerNorm, ape=False, patch_norm=True,
